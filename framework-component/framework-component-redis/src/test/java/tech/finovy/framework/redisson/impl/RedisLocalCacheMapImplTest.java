...
class RedisLocalCacheMapImplTest {
    ...
    void testPut() {
        ...
        when(mockClient.getLocalCachedMap(eq("test:1.0:LocalCacheMap:mapKey"), any(LocalCachedMapOptions.class))).thenReturn(cachedMap);

        // Run the test
        redisLocalCacheMapImplUnderTest.put("mapKey", "test:1.0:LocalCacheMap:mapKey", "value");
    }
    ...
    void testFastPut() {
        ...
        when(mockClient.getLocalCachedMap(eq("test:1.0:LocalCacheMap:mapKey"), any(LocalCachedMapOptions.class))).thenReturn(cachedMap);
        // Run the test
        final boolean result = redisLocalCacheMapImplUnderTest.fastPut("mapKey", "test:1.0:LocalCacheMap:mapKey", "value");
    ...
    void testGet() {
        ...
        // Run the test
        final Serializable result = redisLocalCacheMapImplUnderTest.get("mapKey", "test:1.0:LocalCacheMap:mapKey");
    ...
    void testComputeIfAbsent() {
        ...
        // Run the test
        final Serializable result = redisLocalCacheMapImplUnderTest.computeIfAbsent("mapKey", "test:1.0:LocalCacheMap:mapKey", mappingFunction);
    ...
    void testContainsKey() {
        ...
        // Run the test
        final boolean result = redisLocalCacheMapImplUnderTest.containsKey("mapKey", "test:1.0:LocalCacheMap:mapKey");
    ...
    void testRemove() {
        ...
        // Run the test
        final Serializable result = redisLocalCacheMapImplUnderTest.remove("mapKey", "test:1.0:LocalCacheMap:mapKey");
    ...
    void testFastRemove() {
        ...
        // Run the test
        final long result = redisLocalCacheMapImplUnderTest.fastRemove("mapKey", "test:1.0:LocalCacheMap:mapKey");
