...
public interface LocalCacheMapApi {
    ...
    <T extends Serializable> Set<T> cachedKeySet(String mapKey);
    <T extends Serializable> Collection<T> cachedValues(String mapKey);
    void preloadCache(String mapKey);
    void preloadCache(String mapKey,int count);
