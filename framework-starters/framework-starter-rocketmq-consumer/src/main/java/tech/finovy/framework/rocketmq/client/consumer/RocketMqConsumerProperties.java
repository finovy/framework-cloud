...
public class RocketMqConsumerProperties {
    ...
    static class Producer {
        ...
        private String producerGroup = "framework-group";
        ...
        public String getProducerAccessChannel() {
            return producerAccessChannel;
        }

        public void setProducerAccessChannel(String producerAccessChannel) {
            this.producerAccessChannel = producerAccessChannel;
        }
