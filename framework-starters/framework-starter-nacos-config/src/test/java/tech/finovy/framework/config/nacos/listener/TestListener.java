...
@Slf4j
public class TestListener extends AbstractNacosConfigDefinitionListener<TestItem> {
    protected TestListener(String dataId, String dataGroup, String namespace) {
