...
@Slf4j
public class TestListener2 extends AbstractNacosConfigDefinitionListener<TestItem> {
    protected TestListener2(String dataId, String dataGroup, String namespace) {
