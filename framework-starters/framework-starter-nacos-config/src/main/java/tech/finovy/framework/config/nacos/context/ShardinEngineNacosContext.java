...
@Slf4j
public class ShardinEngineNacosContext {
    ...
    public ShardinEngineNacosContext(ConfigService configService) {
        this.configService = configService;
    }

    public ShardinEngineNacosContext(ConfigService configService, List<NacosConfigDefinitionListener> listeners) {
        this.configService = configService;
