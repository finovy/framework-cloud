...
public enum OidcAuthorizationProvider {
    ...
    KEYCLOAK {
        ...
        public ClientRegistration getBuilder(OAuth2ClientProperties properties) {
            ...
            builder.authorizationUri("https://keycloak.finovy.cn/realms/master/protocol/openid-connect/auth");
            builder.userInfoUri("https://keycloak.finovy.cn/realms/master/protocol/openid-connect/userinfo");
            builder.tokenUri("https://keycloak.finovy.cn/realms/master/protocol/openid-connect/token");
            builder.jwkSetUri("https://keycloak.finovy.cn/realms/master/protocol/openid-connect/certs");
            builder.issuerUri("https://keycloak.finovy.cn/realms/master");
