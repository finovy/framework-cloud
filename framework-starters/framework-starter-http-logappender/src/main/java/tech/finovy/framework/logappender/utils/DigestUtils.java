...
public final class DigestUtils {
    ...
    public static void addSignature(String accessKeyId, String accessKey, String verb,
        ...
        builder.append(AbstractUtils.getOrEmpty(headers, Consts.CONST_CONTENT_MD5)).append("\n");
        builder.append(AbstractUtils.getOrEmpty(headers, Consts.CONST_CONTENT_TYPE)).append("\n");
        builder.append(AbstractUtils.getOrEmpty(headers, Consts.CONST_DATE)).append("\n");
    ...
    private static String urlParametersToString(Map<String, String> paras) {
        Map<String, String> treeMap = new TreeMap<>(paras);
        StringBuilder builder = new StringBuilder();
