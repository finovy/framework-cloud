...
import tech.finovy.framework.logappender.exception.ResultFailedException;
...
public class PushBatch implements Delayed {

    private static final Logger LOGGER = LoggerFactory.getLogger(PushBatch.class);
    ...
    public PushBatch(GroupKey groupKey, String packageId, int batchSizeThresholdInBytes, int batchCountThreshold, int maxReservedAttempts, long nowMs) {
    ...
    public int compareTo(@Nonnull Delayed o) {
        return (int) (nextRetryMs - ((PushBatch) o).getNextRetryMs());
    }
