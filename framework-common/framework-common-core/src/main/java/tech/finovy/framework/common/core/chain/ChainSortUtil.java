...
import tech.finovy.framework.common.core.exception.DistributedListenerException;
...
public class ChainSortUtil {
    ...
    public static <T extends ChainListener> Map<String, Map<String, T>> multiChainListenerSort(Map<String, T> filters) {
        ...
        filters.entrySet()
                ...
                .forEachOrdered(x -> initListenerMap(distributedListeners, x.getValue()));
    ...
    private static <T extends ChainListener> void initListenerMap(Map<String, Map<String, T>> flowHandlerListeners, T listener) {
