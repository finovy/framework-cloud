...
import tech.finovy.framework.common.core.exception.NotSupportYetException;
...
public class BeanUtils {
    ...
    public static Object mapToObject(Map<String, String> map, Class<?> clazz) {
        ...
        try {
            ...
            throw new NotSupportYetException(
                    "map to " + clazz + " failed:" + e.getMessage(), e);
    ...
    public static Map<String, String> objectToMap(Object object) {
        ...
        try {
            ...
            throw new NotSupportYetException(
                    "object " + object.getClass() + " to map failed:" + e.getMessage());
        }
        return map;
    }
