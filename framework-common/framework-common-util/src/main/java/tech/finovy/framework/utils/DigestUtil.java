...
public class DigestUtil extends DigestUtils {
	 ...
	 * @return 返回String
	 */
	public static String encryptForPhp(String content) {
		try {
			// Create MD5 Hash
	 ...
	 * @return
	 */
	public static String phpInterPayUserForSha1(String content) {
		return DigestUtil.encryptForPhp(DigestUtil.encryptForPhp(content)+"asd64x6584a__asd120399dkcx/*/asd565").toUpperCase();
	}
