...
import tech.finovy.framework.core.common.executor.Initialize;
import tech.finovy.framework.core.common.util.CollectionUtils;
import tech.finovy.framework.core.common.util.StringUtils;
...
public class EnhancedServiceLoader {
    ...
    private static class InnerEnhancedServiceLoader<S> {
        ...
        private static final String SHARDING_ENGINE_DIRECTORY = "META-INF/sharding_engine/";
        ...
        private S loadExtension(String activateName, ClassLoader loader, Class[] argTypes,
            ...
            try {
                ...
                if (e instanceof EnhancedServiceNotFoundException exception) {
                    throw exception;
                } else {
                    throw new EnhancedServiceNotFoundException(
                            "not found service provider for : " + type.getName() + " caused by " + ExceptionUtils
        ...
        private List<ExtensionDefinition<S>> findAllExtensionDefinition(ClassLoader loader) {
            ...
            try {
                ...
                loadFile(SHARDING_ENGINE_DIRECTORY, loader, extensionDefinitions);
            } catch (IOException e) {
        ...
        private S initInstance(Class<S> implClazz, Class<?>[] argTypes, Object[] args)
            ...
            if (s instanceof Initialize initialize) {
                initialize.init();
            }
            return s;
        }
